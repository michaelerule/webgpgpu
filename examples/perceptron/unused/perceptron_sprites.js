function sprite_renderer(gl,points,npoint,ndot) {
    
    // Total sprites used:
    // all cursors (npoint)
    // Times number of trailing "dots" (ndot)
    // Plus one point for a virtual mouse cursor
    var ndots_total = npoint*ndot+1;
    ...
    function render_sprites(background,sprites,output) {
